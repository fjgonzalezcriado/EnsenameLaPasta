...
public interface ICashService
{
    ...
    /// <summary>Suma neta de movimientos (ingresos − retiradas).</summary>
    Task<decimal> GetNetDepositsAsync(CancellationToken cancellationToken = default);

    /// <summary>Registra un movimiento (importe &gt; 0 ingreso, &lt; 0 retirada). Devuelve su Id.</summary>
    Task<Guid> AddAsync(decimal amount, string? note, DateTime? createdAtUtc = null, CancellationToken cancellationToken = default);
